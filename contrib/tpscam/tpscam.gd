...
func _ready():
	#cam = get_tree().get_root().get_node("./DemoLevelSuper/EnvParent/PlayerMale/camWrapper/cam")
	#pivot = get_tree().get_root().get_node("./DemoLevelSuper/EnvParent/PlayerMale/camWrapper/pivot")
	cam = get_node(cam)
